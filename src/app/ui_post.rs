                            ...
                            FeedItem::Full(post) => {
                                let post_block = ui.vertical(|ui| {
                                    ...
                                    ui.horizontal(|ui| {
                                        ...
                                        let like_btn = ui.button(like_text).on_hover_text("Right-click to show likers");
                                        if like_btn.clicked() {
                                        ...
                                        let repost_btn = ui.button(repost_text).on_hover_text("Right-click to show reposters");
